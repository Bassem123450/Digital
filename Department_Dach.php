...
<body>
  <div class="container-fluid">
    <header class="bg-primary text-white py-4 mb-4">
      <div class="container">
        <h1>Digital Crafters - Department</h1>
      </div>
    </header>
    <div class="row">
      <div class="col-md-3">
        ...
        <div id="sidebar" class="bg-black">
          <ul>
            ...
            <li><a href="Departments_Dash.php" class="active" data-table="Departments"><i class="fas fa-building"></i> Departments</a></li> <!-- Updated link -->
          </ul>
      ...
      <div class="col-md-9">
        ...
        <div id="main-content" class="p-4 bg-light rounded">
          <!-- Search bar -->
          <input type="text" id="searchInput" class="form-control mb-3" placeholder="Search Department..."> <!-- Updated placeholder -->
          <!-- Default table for Departments -->
          <table class="table">
            <thead>
              <tr>
