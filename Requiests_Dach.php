...
<div class="container-fluid">
    <header class="bg-primary text-white py-4 mb-4">
        <div class="container">
            <h1>Digital Crafters - Requests</h1>
        </div>
    </header>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div id="sidebar" class="bg-black">
                <ul>
                    ...
                    <li><a href="Requiests_Dach.php" class="active" data-table="Requests"><i class="fas fa-clipboard-list"></i> Requests</a></li>
        ...
        <div class="col-md-9">
            ...
            <div id="main-content" class="p-4 bg-light rounded">
                <!-- Search bar -->
                <input type="text" id="searchInput" class="form-control mb-3" placeholder="Search Requests...">
                <!-- Requests Table -->
                <table class="table">
                    <thead>
                    <tr>
